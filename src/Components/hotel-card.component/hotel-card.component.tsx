...
import {COLOR_DANGER, COLOR_SUCCESS} from "../../../native-base-theme/variables/config";
...
export default ({hotel: {hotel_id, image, name, location, address, price, star, room}, hotelFacilities, book}: Props) => {
  ...
  return (
      <View style={[Style.w__100]}>
        <View style={{width: '100%', height: 100, backgroundColor: COLOR_SUCCESS}}/>
        <Image source={{uri: image}} style={{width: '100%', height: 100}}/>
        <View style={{width: '100%', height: 1000, backgroundColor: COLOR_DANGER}}/>
      </View>
  );
};
